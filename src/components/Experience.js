const Experience = () => {
    return (
        <div className="experience">
            ...
            <ul>
                <li>
                    <i><font color="blue">Visitation Makumbi High School</font></i> - <strong>O'Level & A'Level</strong>, January 2011 - December 2013
                    <ul>
                ...
                <li>
                    <i><font color="blue">Catholic University of Zimbabwe</font></i> - <strong>Under Graduate Study</strong>, January 2014 - December 2018
                    <ul>
                        <li>Graduated with 2.1 (Upper Second Class)</li>
                    </ul>
                </li>
                <li>
                    <i><font color="blue">ZESA Holdings</font></i> - <strong>Internship</strong>, January 2019 - December 2019
                    <ul>
                        <li>Studied Harware and Networking</li>
                        <li>Assisted Research &amp; Development on Web3 Products</li>
                    </ul>
                </li>
                <li>
                    <i><font color="blue">Shungu DzeVana Childrens Home</font></i> - <strong>Voluntary</strong>, August 2019 - December 2019
                    <ul>
                ...
                <li>
                    <i><font color="blue">Mangwana Private Limited</font></i> - <strong>Post Graduate Study</strong>, January 2020 - December 2020
                    <ul>
                ...
                <li>
                    <i><font color="blue">Netcast System</font></i> - <strong>ICT Tender Contractor</strong>, June 2021 - today
                    <ul>
